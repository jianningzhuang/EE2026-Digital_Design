...
module Top_Student (
    ...
    snake snake_game (CLK100MHZ, clk_50hz, up_press, down_press, left_press, right_press, centre_press, start_snake, sw[15], sw[14], x, y, mic_in, oled_snake);
    ...
    bishi_bashi bb (CLK100MHZ, clk_50hz, clk_381hz, up_press, down_press, left_press, right_press, centre_press, btnL, btnR, sw, start_bb, x, y, mic_in, oled_bb, seg_bb, an_bb);
