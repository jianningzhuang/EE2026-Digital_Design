...
HD_PWD='C:/Users/Jianning/Desktop/EE2026/Week 6/lab_3/lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log slow_blinky_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source slow_blinky_module.tcl -notrace
