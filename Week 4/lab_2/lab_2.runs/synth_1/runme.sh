...
HD_PWD='C:/Users/Jianning/Desktop/EE2026/Week 4/lab_2/lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_2_to_1_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_2_to_1_mux.tcl
