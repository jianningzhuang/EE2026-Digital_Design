...
HD_PWD='C:/Users/Jianning/Desktop/EE2026/Week 3/lab_1_graded/lab_1_graded.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_to_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source switch_to_LED.tcl -notrace
