...
HD_PWD='C:/Users/Jianning/Desktop/EE2026/Week 3/lab_1_graded/lab_1_graded.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_to_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source switch_to_LED.tcl
